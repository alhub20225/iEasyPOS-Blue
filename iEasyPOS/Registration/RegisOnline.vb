...
Public Class RegisOnline
    ...
    End Function
    Dim RegisType As String = "iEasyPOS(SK)"

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click

        Try
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\iEasyPOS\POS", "KEY", TextBoxRegisKey.Text)
            ...
            If CheckKey.Rows.Count = 1 Then
                ...
                Exit Sub
            Else
                ExecuteMysql("insert into Registration (RegisName,RegisKey,Address,Telephone,ContaceName,RegisType,RegisDate,isDEMO,ActiveIP,LastActive) VALUES ('" & TextBoxRegisName.Text & "','" & TextBoxRegisKey.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & RegisType & "','" & RegisDate & "',1,'" & GetIP() & "','" & RegisDate & "')")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim Regiskey As String = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\iEasyPOS\POS", "KEY", Nothing)
        ...
        Else
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\iEasyPOS\POS", "VerifiedKEY", TextBoxVerified.Text)
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\IE\C3", "C", "qDYamMlSx0M=")
