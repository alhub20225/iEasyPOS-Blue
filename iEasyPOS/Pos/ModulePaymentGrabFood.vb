...
Module ModulePaymentGrabFood
    Dim Balance As Decimal
    Dim NewSaleId As Integer = 0
    Sub GrabFoodAddSale(ByVal PaymentType As Integer, ByVal Subtotal As Decimal, GrabNo As String)
        ...
        Dim GrabNumber As String = "GF-" & GrabNo
