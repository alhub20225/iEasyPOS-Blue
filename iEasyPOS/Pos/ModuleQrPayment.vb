Module ModuleQrPayment
    Function ThaiQr(totalPrice As Decimal)
        ...
        Dim requestDt As String = Convert.ToDateTime(Now).ToString("yyyy-MM-ddTHH:mm", New System.Globalization.CultureInfo("en-US"))
        ...
        partnerTxnUid = "HQCTM" + Convert.ToDateTime(Now).ToString("yyyyMMdd", New System.Globalization.CultureInfo("en-US")) + MaxRows.ToString
