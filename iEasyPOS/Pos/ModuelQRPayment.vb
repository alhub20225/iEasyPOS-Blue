Module ModuelQRPayment
    ...
    Function ThaiQr()
        FrmQRPayment.PictureBoxQR.Image = Nothing
        Dim partnerTxnUid As String = ""
        Dim partnerId As String = "CRP0000011" ' "CTM001" '  '"PTR0000030"
        Dim partnerName As String = "Cha Tra Mue"
        Dim partnerSecret As String = "WJ4V6SXA8tk3Kpj0XXY9l8iNBkRtGfCCWr5UE7hy0Y66Pz5SSUSb5vsUSrBCYIr9" '"Qxdl5KZfISQFqC1JNzsxzhGDZmecmU9oa4sgfN6oVipR3oX6t2w97UvCQPEh8PDo" 
        Dim requestDt As String = Convert.ToDateTime(Now).ToString("yyyy-MM-ddTHH:mm:ss", New System.Globalization.CultureInfo("th-TH"))
        Dim merchantId As String = "KB000001518278" '"CTM002""EXT01000250227"  
