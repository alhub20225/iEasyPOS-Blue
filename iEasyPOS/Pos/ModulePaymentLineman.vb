...
Module ModulePaymentLineman
    Dim Balance As Decimal
    Dim NewSaleId As Integer = 0
    Sub LinemanAddSale(ByVal PaymentType As Integer, ByVal Subtotal As Decimal, LinemanNo As String)
        ...
        Dim lineManNumber As String = LinemanNo
        Dim BankNumber As String = 0

        TotalCash = Subtotal

        executesql("INSERT INTO PaymentDetail(SaleId,PaymentTypeId,BankId,EdcBankId,BankCardTypeId,CardTypeId,PaidAmount,CouponNumber,VoucherNumber,BankNumber) VALUES('" & selectSaleId(0)("SaleId") & "','" & PaymentType & "'," & BankId & ",'" & EdcBankId & "','" & BankCardTypeId & "','" & CardTypeId & "','" & Subtotal & "','" & CouponNumber & "','" & lineManNumber & "','" & BankNumber & "')")
