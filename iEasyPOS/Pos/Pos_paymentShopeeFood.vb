Public Class Pos_paymentShopeeFood
    Private Sub BtnGrabPay_Click(sender As Object, e As EventArgs) Handles BtnGrabPay.Click
        ...
        Dim getPaymentLineman As DataTable = executesql("select PaymentId from Paymenttype where PaymentName = 'ShopeeFood'")
        If getPaymentLineman.Rows.Count = 0 Then
            MsgBox("ไม่มีระบบชำระเงินผ่าน ShopeeFood", MsgBoxStyle.Critical, "")
            Exit Sub
        End If
        ShopeeFoodAddSale(getPaymentLineman(0)("PaymentId"), POS.txtSubTotal.Text, txtGrabNumber.Text)
