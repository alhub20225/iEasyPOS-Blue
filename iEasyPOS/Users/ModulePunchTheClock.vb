Module ModulePunchTheClock
    ...
    Sub loadUserData()
        Try
            'Dim selectUser As DataTable = ModuleGetDataAPI.gett("http://testnoi.hiveup.co/api/vbapi.php?action=SELECT&field=Users.FirstName,Users.LastName,Users.Image,Roles.RoleName&table=Users INNER JOIN Roles ON Roles.RoleId=Users.RoleId&where=Users.UserId='" & Frm_Login.SendUserId & "' and Users.Active = 1")
            Dim selectUser As DataTable = executesql("SELECT Users.FirstName,Users.LastName,Users.Image,Roles.RoleName FROM Users INNER JOIN Roles ON Roles.RoleId=Users.RoleId WHERE Users.UserId='" & Frm_Login.SendUserId & "' and Users.Active = 1")
            Frm_PunchTheClock.LabelUserName.Text = selectUser(0)("FirstName") & " " & selectUser(0)("LastName")
    ...
    Sub btnTimeIn()
        ...
        executesql("INSERT INTO PunchTheClock(UserId,DateOfWork,ClockIn,Active) VALUES('" & Frm_Login.SendUserId & "','" & Format(Now, "yyyy-MM-dd") & "','" & Main2.LabelTime.Text & "','1')")
        Frm_Critical.Show()
    ...
    Sub btnTimeOut()
        ...
        Dim Tnow As String = Main2.LabelTime.Text
        ...
        executesql("UPDATE PunchTheClock SET ClockOut='" & Main2.LabelTime.Text & "' WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork='" & Format(Now, "yyyy-MM-dd") & "'")
        Frm_Critical.Show()
        Frm_Critical.head_Label.Text = "บันทึกข้อมูลเรียบร้อย"
        Frm_Critical.Panel1.BackColor = Color.ForestGreen
        Frm_Critical.TableOkCancel.Visible = False
    ...
    Sub btnBreakIn()
        ...
        executesql("UPDATE PunchTheClock SET ClockBreakIn='" & Main2.LabelTime.Text & "' WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork='" & Format(Now, "yyyy-MM-dd") & "'")
        Frm_Critical.Show()
        Frm_Critical.head_Label.Text = "บันทึกข้อมูลเรียบร้อย"
        Frm_Critical.Panel1.BackColor = Color.ForestGreen
        Frm_Critical.TableOkCancel.Visible = False
    ...
    Sub btnBreakOut()
        ...
        executesql("UPDATE PunchTheClock SET ClockBreakOut='" & Main2.LabelTime.Text & "' WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork='" & Format(Now, "yyyy-MM-dd") & "'")
        Frm_Critical.Show()
        Frm_Critical.head_Label.Text = "บันทึกข้อมูลเรียบร้อย"
        Frm_Critical.Panel1.BackColor = Color.ForestGreen
        Frm_Critical.TableOkCancel.Visible = False
    ...
    Sub btnOTIn()
        ...
        executesql("UPDATE PunchTheClock SET ClockOTIn='" & Main2.LabelTime.Text & "' WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork='" & Format(Now, "yyyy-MM-dd") & "'")
        Frm_Critical.Show()
        Frm_Critical.head_Label.Text = "บันทึกข้อมูลเรียบร้อย"
        Frm_Critical.Panel1.BackColor = Color.ForestGreen
        Frm_Critical.TableOkCancel.Visible = False
    ...
    Sub btnOTOut()
        ...
        If IsDBNull(checkOTIn(0)("ClockOTIn")) Then
            ...
            Exit Sub
        End If
        Dim totalTimeOTOfDay = DateDiff(DateInterval.Hour, CDate(checkOTIn(0)("ClockOTIn").ToString), CDate(Main2.LabelTime.Text))
        ...
        executesql("UPDATE PunchTheClock SET ClockOTOut='" & Main2.LabelTime.Text & "' WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork='" & Format(Now, "yyyy-MM-dd") & "'")
        Frm_Critical.Show()
        Frm_Critical.head_Label.Text = "บันทึกข้อมูลเรียบร้อย"
        Frm_Critical.Panel1.BackColor = Color.ForestGreen
        Frm_Critical.TableOkCancel.Visible = False
    ...
    Sub btnSearch()
        ...
        Dim selectTime As DataTable = executesql("SELECT UserId,DateOfWork,ClockIn,ClockOut,ClockBreakIn,ClockBreakOut,ClockOTIn,ClockOTOut,ClockTotalTimeOfDay,ClockTotalTimeOfOT,Active FROM PunchTheClock WHERE UserId='" & Frm_Login.SendUserId & "' AND DateOfWork = '" & Frm_PunchTheClock.DateTimePickerSearch.Text & "' AND Active = 1")
        Dim _cultureEnInfo As New Globalization.CultureInfo("en-US")
        For i As Integer = 0 To selectTime.Rows.Count - 1
            Dim dateFromDB As DateTime = Convert.ToDateTime(selectTime(i)("DateOfWork"), _cultureEnInfo)
