Public Class Frm_Nationality
    ...
    Private Sub Nationality_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DataGridView_ShowNationality.RowTemplate.Height = 35
        loadData()
    End Sub
    Sub loadData()
    ...
    Private Sub btnAddNationality_Click(sender As Object, e As EventArgs) Handles btnAddNationality.Click
        If txtNationalityTH.Text = "" Or txtNationalityEN.Text = "" Then
            ...
            Exit Sub
        End If
        If ComboBoxNationaliyActive.Text = "สถานะ" Or ComboBoxNationaliyActive.Text = Nothing Then
            MsgBox("กรุณาเลือกสถานะ", MsgBoxStyle.Critical)
            Exit Sub
        End If
        If ComboBoxNationaliyActive.Text = "เปิด" Then
            IdStatus.Text = 1
        ElseIf ComboBoxNationaliyActive.Text = "ปิด" Then
            IdStatus.Text = 0
        End If
        ...
        Else
            Try
                ...
                executesql("UPDATE Nationality SET NationalityNameTH='" & txtNationalityTH.Text & "',NationalityNameEN='" & txtNationalityEN.Text & "',Active='" & IdStatus.Text & "' WHERE NationalityId='" & nationalityId & "'")
    ...
    Private Sub ComboBoxNationaliyActive_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxNationaliyActive.SelectedIndexChanged
        If ComboBoxNationaliyActive.Text = "เปิด" Then
            IdStatus.Text = 1
        ElseIf ComboBoxNationaliyActive.Text = "ปิด" Then
            IdStatus.Text = 0
