Public Class Frm_Break
    ...
    Private Sub Frm_Break_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DataGridView_Break.RowTemplate.Height = 35
        loadData()
    End Sub
    Sub loadData()
    ...
    Private Sub btnAddBreak_Click(sender As Object, e As EventArgs) Handles btnAddBreak.Click
        If txtBreak.Text = "" Then
            ...
            Exit Sub
        End If
        If ComboBoxBreakActive.Text = "เปิด" Then
            IdStatus.Text = 1
        ElseIf ComboBoxBreakActive.Text = "ปิด" Then
            IdStatus.Text = 0
        End If
        ...
        Try
            ...
            Else
                ...
                executesql("UPDATE Breaks SET BreakName='" & txtBreak.Text & "', Active='" & IdStatus.Text & "' WHERE BreakId='" & DataGridView_Break.CurrentRow.Cells(0).Value & "'")
            End If
    ...
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        Me.Close()
        txtBreak.Clear()
        ComboBoxBreakActive.Properties.Items.Clear()
    End Sub

    Private Sub ComboBoxBreakActive_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxBreakActive.SelectedIndexChanged
        If ComboBoxBreakActive.Text = "เปิด" Then
            IdStatus.Text = 1
        ElseIf ComboBoxBreakActive.Text = "ปิด" Then
            IdStatus.Text = 0
