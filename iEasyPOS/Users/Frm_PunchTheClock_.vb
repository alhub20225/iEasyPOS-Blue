Public Class Frm_PunchTheClock
    Private Sub Frm_PunchTheClock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DateTimePickerSearch.EditValue = Now
        DateTimePickerSearch.Properties.DisplayFormat.FormatString = "yyyy-MM-dd"
        DateTimePickerSearch.Properties.Mask.EditMask = "yyyy-MM-dd"
        'TimerNow.Start()
    ...
    'Private Sub Close_PunchTime_Click(sender As Object, e As EventArgs) Handles Close_PunchTime.Click
    '    Me.Close()
    '    Main.Close()
    '    Main.Show()
    'End Sub
