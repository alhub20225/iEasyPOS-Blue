...
Partial Public Class OrderTableSingle
    ...
    Private Sub InitializeComponent()
        ...
        'XrLabel7
        '
        Me.XrLabel7.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Sale.FristName")})
        ...
        'DataColumn8
        '
        Me.DataColumn8.ColumnName = "FristName"
        '
        'GroupFooter1
        '
