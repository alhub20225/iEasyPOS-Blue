    ...
    Sub loadQ()
        ...
        For i As Integer = 0 To selectType.Rows.Count - 1
            ...
            For q As Integer = 0 To selectQ.Rows.Count - 1
                ...
                Dim totalTime = DateDiff(DateInterval.Minute, CDate(selectQ(0)("StartTime")), CDate(Table.txtTableTime.Text))
                ...
                If totalTime > 30 Then
                    Btn_Q.Image = Global.Project_CTM.My.Resources.Resources.Smile_Red64
                ElseIf totalTime <= 30 Then
                    Btn_Q.Image = Global.Project_CTM.My.Resources.Resources.Smile_Green64
                End If
