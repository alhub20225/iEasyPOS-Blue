Public Class Report_Kiosk
    Dim DTS As String = ModuleShift.DateOpen
    Dim DTE As String = ModuleShift.DateClose
    Private Sub Report_Kiosk_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        'DTS = "2561-11-22 00:00:00"
        'DTE = "2561-11-22 23:59:00"
        Dim TerminalName As String = "DESKTOP-FQDNIKV"
