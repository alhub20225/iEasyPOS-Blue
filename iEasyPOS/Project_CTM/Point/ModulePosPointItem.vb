Module ModulePosPointItem
    Sub customerData()
        ...
        Clipboard.SetText("SELECT FirstName,MidName,LastName,Point,MemberNo FROM Customer WHERE MemberNo = '" & cusMemberNo & "'")
    ...
    Sub btnSave()
        If FrmUsePoint.DataGridViewUseItemPoint.RowCount <> 0 Then
            ...
            For i As Integer = 0 To FrmUsePoint.DataGridViewUseItemPoint.RowCount - 1
                ...
                'Clipboard.SetText("INSERT INTO UsePointItem(ItemId,InsertDate,PointRate,CustomerNo,UserId,Qty) VALUES('" & ItemId & "','" & InsertDate & "','" & PointToRedeem & "','" & FrmCustomerMemberNo.customerMemNo & "','" & Frm_Login.UserId & "','" & FrmUsePoint.DataGridViewUseItemPoint.Rows(i).Cells(1).Value & "')")
