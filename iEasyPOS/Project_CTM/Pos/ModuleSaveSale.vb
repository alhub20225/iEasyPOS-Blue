...
where SaleItem.SaleItemId='" & selectSaleData(a)("SaleItemId") & "'")
    ...
    End Sub
    Sub btnSave()
        'Dim saleName As String = Pos_SaveSaleName.SaleName
        ...
        '    executesql("INSERT INTO Sale(Subtotal,Total,InsertDate,IsCloseBill,Active,CustomerId,StartTime,AmountDC,TerminalName) VALUES('" & subtotal & "','" & total & "','" & InsertDate & "'," & IsCloseBill & "," & Active & ",'" & CustomerId & "','" & StartTime & "','" & AmountDC & "','" & TerminalName & "')")
        ...
        '        executesql("INSERT INTO UsePromotion(SaleId,PromotionId,ItemPromotionId,InsertDate) VALUES('" & selectSaleId(0)("SaleId") & "','" & PromotionId & "','" & ItemPromotionId & "','" & InsertDate & "')")

        '    End If
        'Else
        '    executesql("UPDATE SaleTable SET SaleName='" & saleName & "',UpdateDate='" & UpdateDate & "' WHERE SaleId='" & GetSaleId & "'")
        '    For i As Integer = 0 To POS.DataGridViewPOS.Rows.Count - 1
        '        ItemId = POS.DataGridViewPOS.Rows(i).Cells("ItemId").Value
        '        Qty = POS.DataGridViewPOS.Rows(i).Cells(1).Value
