...
Module NotificationRegis
    ...
    Sub SendMailNotiRegis(key As String, RegisName As String, Address As String)
        ...
        emailmessage.Subject = "CTM POS Registration"
        emailmessage.Body = "Registration [ CTM POS ] " + vbCrLf + "Regis Key : " + key + vbCrLf + "Regis Name : " + RegisName + vbCrLf + "Address : " + Address + vbCrLf + "Computer Name : " + TerminalName + vbCrLf + "IP : " + myIP
