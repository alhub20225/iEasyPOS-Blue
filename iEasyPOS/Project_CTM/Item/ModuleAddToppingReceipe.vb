Module ModuleAddToppingReceipe
    Sub loadMatCate()
        ...
        ElseIf selectCategoryMaterial.Rows.Count = 0 Then
            Exit Sub
        End If
        FrmToppings.RadDropDownListCategoryMatTopping.Items.Clear()
        For i As Integer = 0 To selectCategoryMaterial.Rows.Count - 1
            FrmToppings.RadDropDownListCategoryMatTopping.Items.Add(selectCategoryMaterial(i)("CategoryName"))
        Next
    End Sub
    Sub btnSearch()
