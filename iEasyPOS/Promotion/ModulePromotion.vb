Module ModulePromotion
    ...
    Sub AddToDataGridViewGetFree()
        ...
        If selectDataItem.Rows.Count = 0 Then Exit Sub
        If Promotion.DataGridViewGetFree.RowCount > 0 Then
            For i As Integer = 0 To Promotion.DataGridViewGetFree.RowCount - 1
                If selectDataItem(0)("ItemName") = Promotion.DataGridViewGetFree.Rows(i).Cells(0).Value Then
                    Exit Sub
                Else
    ...
    Sub clearDataGetFree()
        ...
        Promotion.CheckBoxFree.Checked = False
        Promotion.NumGetItemDiscount.Enabled = True
    End Sub
    Sub btnAddPromotion()
    ...
    Sub showData()
        ...
        Promotion.NumericUpDownCon.Value = ShowData(0)("ConAmount")
