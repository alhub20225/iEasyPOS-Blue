Module ModulePointRate
    ...
    End Sub
    Sub btnSearch()
        Dim SearchData As DataTable = executesql("SELECT * FROM PointRate WHERE Active ='1' AND DateStart >= '" & Convert.ToDateTime(FrmPointRate.DateTimePicker1.Text).ToString("yyyy-MM-dd", New System.Globalization.CultureInfo("en-US")) & "'")
        FrmPointRate.DataGridViewPoint.Rows.Clear()
    ...
    '        Item.DataGridView3.Rows.Clear()
    '        Item.DataGridViewItemPointRate.Rows.Add(Convert.ToDateTime(selectPointRate(0)("DateStart")).ToString("dd/MM/yyyy", New System.Globalization.CultureInfo("en-US")), selectPointRate(0)("PointRate"), selectPointRate(0)("PointRateId"))
    '        Item.DataGridView3.Rows.Add(selectPointRate(0)("PointRateId"), Convert.ToDateTime(selectPointRate(0)("DateStart")).ToString("dd/MM/yyyy", New System.Globalization.CultureInfo("en-US")), selectPointRate(0)("PointRate"))
