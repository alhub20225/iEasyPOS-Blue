Module ModuleManageItemPoint
    ...
    Sub loadCategory()
        ...
        For i As Integer = 0 To cateData.Rows.Count - 1
            FrmManagePoint.ComboBoxSelectCategory.Properties.Items.Add(cateData(i)("CategoryName"))
        Next
    End Sub
    Sub loadPintRate()
        ...
        For i As Integer = 0 To FrmManagePoint.DataGridViewShowItem.Rows.Count - 1
            If FrmManagePoint.DataGridViewShowItem.Rows(i).Cells("ItemSelect").Value = True Then
                ...
                If checkPointRate.Rows.Count = 0 Then
                    Dim checkPromotionPoint As DataTable = executesql("Select  Promotion.ProId,Promotion.ProName,ConditionPromotion.ConPrice,ConditionPromotion.ConAmount,ConditionPromotion.AlertAmount,ConditionPromotion.AlertPrice,ConditionPromotion.ConTimeEnd,ConditionPromotion.ConDateStart,ConditionPromotion.ConTimeStart,ConditionPromotion.ConDateEnd,GiftValue.GiftId,GiftValue.DiscountPer,GiftValue.DiscountB,GiftValue.Point,PromotionItem.ItemId,Item.ItemName FROM Promotion 
