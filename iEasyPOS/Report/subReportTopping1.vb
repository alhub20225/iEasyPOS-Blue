...
Public Class subReportTopping1
    Private Sub subReportTopping1_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
    ...
    Private Sub subReportTopping1_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
