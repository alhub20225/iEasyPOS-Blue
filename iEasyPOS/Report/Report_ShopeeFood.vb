...
Public Class Report_ShopeeFood
    Private Sub Report_ShopeeFood_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
    ...
    Private Sub Report_ShopeeFood_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
