Public Class frm_reportRobinhood
    Private Sub Btn_Search_Click(sender As Object, e As EventArgs) Handles Btn_Search.Click
        Dim report As New Report_Robinhood
    ...
    Private Sub frm_reportRobinhood_Load(sender As Object, e As EventArgs) Handles MyBase.Load
