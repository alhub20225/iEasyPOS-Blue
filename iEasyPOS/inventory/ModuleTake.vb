Module ModuleTake
    Dim CheckTakeId As Integer = 0
    Sub LoadTakeId()

        Dim CountTake As DataTable = executesql("SELECT TakeId FROM TakeItem")
        Dim TakeId As Integer = 0

        If CountTake.Rows.Count = 0 Then
            TakeId = 1
        Else
            TakeId = CountTake.Rows.Count + 1
        End If
        Dim TakeNO As String = "TK" & TakeId.ToString("0000000")
        inventory.TxtTakeId.Text = TakeNO
    ...
    Sub LoadStore()
        ...
        Dim i As Integer
        inventory.RadDropDownListStore.Properties.Items.Clear()
        For i = 0 To RowsDataStore - 1
            inventory.RadDropDownListStore.Properties.Items.Add(DataStore(i)("StockName"))
        Next
    End Sub
    Sub LoadTakeType()
        ...
        Dim i As Integer
        inventory.RadDropDownListTakeType.Properties.Items.Clear()
        For i = 0 To RowsDataTypeItems - 1
            inventory.RadDropDownListTakeTypeSearch.Properties.Items.Add(DataTypeItems(i)("TakeTypeName"))
            inventory.RadDropDownListTakeType.Properties.Items.Add(DataTypeItems(i)("TakeTypeName"))
        Next
    End Sub
    Sub LoadRadDropDownStatus()
        ...
        Dim i As Integer
        inventory.RadDropDownListStatus.Properties.Items.Clear()
        For i = 0 To RowsDataStatus - 1
            inventory.RadDropDownListStatus.Properties.Items.Add(DataStatus(i)("StatusName"))
        Next
    End Sub
    'AutoComplete
    ...
    Sub BtnSrc()
        ...
        Dim StartDate As String = Convert.ToDateTime(inventory.RadDateTimePickerDateSearchStart.Text).ToString("yyyy-MM-dd 00:00:00", New System.Globalization.CultureInfo("en-US"))
        Dim EndDate As String = Convert.ToDateTime(inventory.RadDateTimePickerDateSearchEnd.Text).ToString("yyyy-MM-dd 23:59:59", New System.Globalization.CultureInfo("en-US"))
        ...
        If TakeId <> "" And TakeType = "" Then
            ...
            For i As Integer = 0 To Src.Rows.Count - 1
                Dim TakeTypeName As DataTable = executesql("SELECT TakeTypeName FROM TakeType WHERE TakeTypeId='" & Src(i)("TakeTypeId") & "'")
                inventory.DataGridViewShowTake.Rows.Add(Convert.ToDateTime(Src(i)("TakeDate")).ToString("dd/MM/yyyy", New System.Globalization.CultureInfo("th-TH")), Src(i)("TakeId"), TakeTypeName(i)("TakeTypeName"))
            Next
            Exit Sub
        End If
        If TakeId = "" And TakeType <> "" Then
            ...
            inventory.DataGridViewShowTake.Rows.Clear()
            For i As Integer = 0 To Src.Rows.Count - 1
                inventory.DataGridViewShowTake.Rows.Add(Convert.ToDateTime(Src(i)("TakeDate")).ToString("dd/MM/yyyy", New System.Globalization.CultureInfo("th-TH")), Src(i)("TakeId"), TakeType)
            Next
            Exit Sub
        End If
    End Sub
    Sub LoadDataFromItemId()
        ...
        If inventory.TxtItemCode.Text <> "" And inventory.TxtItemName.Text = "" Then
            ...
            End If
            inventory.RadDropDownListItemUnit.Properties.Items.Clear()
            For i As Integer = 0 To USUnitIdName.Rows.Count - 1
                inventory.RadDropDownListItemUnit.Properties.Items.Add(USUnitIdName(i)("ItemUnitName"))
            Next
            inventory.RadDropDownListItemUnit.Text = Unit(0)("ItemUnitName")
        ElseIf inventory.TxtItemName.Text <> "" And inventory.TxtItemCode.Text = "" Then
            ...
            inventory.RadDropDownListItemUnit.Properties.Items.Clear()
            For i As Integer = 0 To USUnitIdName.Rows.Count - 1
                inventory.RadDropDownListItemUnit.Properties.Items.Add(USUnitIdName(0)("UnitUsename"))
            Next
            inventory.RadDropDownListItemUnit.Text = Unit(0)("ItemUnitName")
        ElseIf inventory.TxtItemName.Text <> "" And inventory.TxtItemCode.Text <> "" Then
            ItemId = inventory.TxtItemCode.Text
            ...
            inventory.RadDropDownListItemUnit.Properties.Items.Clear()
            For i As Integer = 0 To USUnitIdName.Rows.Count - 1
                inventory.RadDropDownListItemUnit.Properties.Items.Add(USUnitIdName(0)("ItemUnitName"))
            Next
            inventory.RadDropDownListItemUnit.Text = Unit(0)("ItemUnitName")
        End If
    End Sub
    ...
    Sub ClearTextAll()
        ...
        inventory.RadDateTimePickerTakeDate.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        inventory.RadDateTimePickerTakeDate.Properties.DisplayFormat.FormatString = "yyyy-MM-dd HH:mm:ss"
        inventory.RadDateTimePickerTakeDate.EditValue = DateTime.Now
        inventory.RadDateTimePickerTakeDate.Properties.Mask.EditMask = "yyyy-MM-dd HH:mm:ss"
    ...
    Sub LoadDataReciveToGridView()
        ...
        For i As Integer = 0 To selectTake.Rows.Count - 1
            ...
            inventory.DataGridViewShowTake.Rows.Add(Convert.ToDateTime(selectTake(i)("TakeDate")).ToString("dd/MM/yyyy", New System.Globalization.CultureInfo("th-TH")), selectTake(i)("TakeId"), TakeTypeId(0)("TakeTypeName"))
        Next
        ClearTextAll()
    End Sub
    Sub ShowDetail()
        If inventory.DataGridViewShowTake.SelectedRows Is Nothing Then
            ...
            Exit Sub
        Else
            Dim selectData As DataTable = executesql("SELECT  Take.id,Take.TakeId,Take.TakeDate,Take.TakeTitle,Take.TakeDetail,TakeType.TakeTypeName,Stock.StockName,StatusSystem.StatusName,Take.TakeTypeId FROM Take INNER JOIN Stock ON Stock.StockId = Take.StockId  INNER JOIN StatusSystem ON StatusSystem.StatusId = Take.StatusId INNER JOIN TakeType ON TakeType.TakeTypeId = Take.TakeTypeId WHERE Take.TakeId='" & inventory.DataGridViewShowTake.CurrentRow.Cells(1).Value & "'")
            ...
            End If
            CheckTakeId = selectData(0)("Id")
            inventory.TxtTakeId.Text = inventory.DataGridViewShowTake.CurrentRow.Cells(1).Value
            inventory.RadDateTimePickerTakeDate.Text = Convert.ToDateTime(selectData(0)("TakeDate")).ToString("yyyy-MM-dd HH:mm:ss", New System.Globalization.CultureInfo("th-TH"))
            ...
            Dim selectDataTakeItem As DataTable = executesql("SELECT TakeId,ItemCode,ItemName,CategoryId,CategoryName,CategoryName2,Amount,ItemUnitId,Multiply,UnitCost,TotalUnitCost FROM TakeItem WHERE TakeId='" & inventory.DataGridViewShowTake.CurrentRow.Cells(1).Value & "'")
            inventory.DataGridViewShowTakeItem.Rows.Clear()
            If selectData(0)("StatusName") = "Approve" Then
                'inventory.GroupBox6.Enabled = False
                inventory.Panel52.Enabled = False
            ...
            ElseIf selectData(0)("StatusName") = "Pending" Then
                'inventory.GroupBox6.Enabled = True
                inventory.Panel52.Enabled = True
    ...
    Sub SaveItems()
        ...
        Dim TakeDate As String = Convert.ToDateTime(inventory.RadDateTimePickerTakeDate.DateTime).ToString("yyyy-MM-dd HH:mm:ss", New System.Globalization.CultureInfo("en-US"))
        ...
        Dim ReciveDate As String = Convert.ToDateTime(inventory.RadDateTimePickerReciveDate.DateTime).ToString("yyyy-MM-dd HH:mm:ss", New System.Globalization.CultureInfo("en-US"))
        ...
        Else
            ...
            If inventory.RadDropDownListStatus.Text = "Not Pass" Then
                executesql("UPDATE Take SET Active=0 WHERE Id='" & CheckTakeId & "'")
                ...
                Exit Sub
            ElseIf inventory.RadDropDownListStatus.Text = "Pending" Then
                executesql("UPDATE Take SET TakeId='" & TakeId & "',TakeDate='" & TakeDate & "',TakeTitle='" & TakeTitle & "',TakeDetail='" & TakeDetail & "',TakeTypeId='" & TakeType(0)("TakeTypeId") & "',StockId='" & DataStoreId(0)("StockId") & "',Total='" & Total & "',StatusId='" & StatusItem(0)("StatusID") & "',UpdateDate='" & InsertDate & "',UserId='" & Frm_Login.UserId & "',Active='" & Active & "' WHERE Id='" & CheckTakeId & "'")
                Dim selectTake As DataTable = executesql("SELECT Max(TakeId) FROM Take")
                ...
                For a As Integer = 0 To inventory.DataGridViewShowTakeItem.Rows.Count - 1
                    ...
                    If checkReciveItem.Rows.Count = 0 Then
                        executesql("INSERT INTO TakeItem(TakeId,ItemCode,ItemName,CategoryId,CategoryName,CategoryName2,Amount,ItemUnitId,Multiply,UnitCost,TotalUnitCost)  VALUES('" & TakeId & "','" & ItemCode & "','" & ItemName & "','" & CategoryId & "','" & CategoryName & "','" & CategoryName2 & "','" & AmountItem & "','" & selectUnit(0)("ItemUnitId") & "','" & Multiply & "','" & UnitCost & "','" & TotalUnitCost & "')")
                    Else
                        executesql("UPDATE TakeItem SET TakeId='" & TakeId & "',ItemCode='" & ItemCode & "',ItemName='" & ItemName & "', CategoryId='" & CategoryId & "',CategoryName='" & CategoryName & "',CategoryName2='" & CategoryName2 & "',Amount='" & AmountItem & "',ItemUnitId='" & selectUnit(0)("ItemUnitId") & "',Multiply='" & Multiply & "',UnitCost='" & UnitCost & "',TotalUnitCost='" & TotalUnitCost & "' WHERE TakeId='" & CheckTakeId & "'")
                    End If
                Next
                MsgBox("บันทึกข้อมูลเรียบร้อยแล้ว", MsgBoxStyle.Information, "")
                LoadDataReciveToGridView()
            ...
            ElseIf inventory.RadDropDownListStatus.Text = "Approve" Then
                ...
                For a As Integer = 0 To inventory.DataGridViewShowTakeItem.Rows.Count - 1
                    ...
                    Else
                        ...
                        executesql("UPDATE TakeItem SET TakeId='" & TakeId & "',ItemCode='" & ItemCode & "',ItemName='" & ItemName & "', CategoryId='" & CategoryId & "',CategoryName='" & CategoryName & "',CategoryName2='" & CategoryName2 & "',Amount='" & AmountItem & "',ItemUnitId='" & selectUnit(0)("ItemUnitId") & "',Multiply='" & Multiply & "',UnitCost='" & UnitCost & "',TotalUnitCost='" & TotalUnitCost & "' WHERE Id='" & CheckTakeId & "'")
                    End If
    ...
    Sub DeleteReciveItem()
        ...
        Else
            If MsgBox("ต้องการลบข้อมูลหรือไม่", MsgBoxStyle.YesNo, "") = MsgBoxResult.Yes Then
                executesql("DELETE FROM TakeItem WHERE ItemCode='" & checkReciveItemId & "' AND Id='" & CheckTakeId & "'")
