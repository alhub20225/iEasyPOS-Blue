Module ModuleManageSupplier
    ...
    End Sub
    Sub LoadPaymentTerm()
        FrmManageSupplier.RadDropDownListPaymentTerm.Properties.Items.Clear()
        field = "PaymentName"
        table = "PaymentType"
        Where = ""
        ...
        For i = 0 To RowsDataPaymentTerm - 1
            ...
            FrmManageSupplier.RadDropDownListPaymentTerm.Properties.Items.Add(PaymentName)
        Next
    End Sub
    ...
    Sub SaveSupplier()
        'CheckSupplierCode()
        'Check Data Detail 
        If FrmManageSupplier.RadDropDownListPaymentTerm.Text = "" Then
