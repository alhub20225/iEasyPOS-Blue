Public Class FrmAmount50
    Private Sub FrmAmount50_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtAmount.Clear()
        txtAmount.Select()
    End Sub
    ...
    Private Sub txtAmount_KeyDown(sender As Object, e As KeyEventArgs) Handles txtAmount.KeyDown
        If e.KeyCode = Keys.Enter Then
            Frm_CloseShift.TxtAmount50.Text = txtAmount.Text
            Me.Close()
    ...
    Private Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        Me.Close()
        If txtAmount.Text = "" Then
            Frm_CloseShift.TxtAmount50.Text = 0
        Else
            Frm_CloseShift.TxtAmount50.Text = txtAmount.Text
        End If
    End Sub
