...
Public Class open_cash
    ...
    Public Shared Sub OpenCashdrawer()
        writeLog("User ID " + Frm_Login.UserId.ToString + " Open Cashdrawer")
        ...
        Printer_name = GetPrinterName(0)("SettingValue")
        Printer_name = Printer_name.TrimEnd(" ")
        ...
        open_cash.PrintRaw(Printer_name, DrawerCode)
    End Sub
End Class
